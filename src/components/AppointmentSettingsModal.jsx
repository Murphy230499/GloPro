    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center font-body">
      ...
      <div className="bg-slate-50 w-[550px] max-w-[95vw] h-[90vh] md:max-h-[85vh] rounded-2xl shadow-xl flex flex-col relative z-10 overflow-hidden">
        ...
        <div className="bg-white flex items-center justify-between p-4 border-b border-slate-200 shrink-0">
          <h2 className="text-lg font-bold text-slate-800">Cài đặt lịch hẹn</h2>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
            <h3 className="text-sm font-bold text-slate-800 mb-1">Thời lượng khung giờ</h3>
            <p className="text-sm text-slate-500 mb-6 leading-relaxed">Điều chỉnh mức độ chi tiết của lịch. Thời lượng ngắn hơn giúp sắp xếp lịch chính xác hơn.</p>
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
            <h3 className="text-sm font-bold text-slate-800">Giới hạn số lượng lịch hẹn</h3>
            <label className="flex items-center gap-3 cursor-pointer group">
              ...
              <span className="text-sm text-slate-700">Áp dụng giới hạn số lượng khách tối đa</span>
            ...
            <div className={`pl-12 transition-all duration-300 ${settings.enableDoubleBooking ? 'opacity-100' : 'opacity-40 pointer-events-none'}`}>
              <div className="text-sm text-slate-500 mb-2">Số lượng khách tối đa mặc định mỗi khung giờ</div>
              ...
              <div className="space-y-3">
                <div className="text-sm font-semibold text-slate-700">Cài đặt riêng cho từng khung giờ</div>
                <p className="text-xs text-slate-500">Đặt giới hạn khác nhau cho các khoảng thời gian cụ thể trong ngày.</p>
          ...
          {/* Staff Selection */}
          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
            <h3 className="text-sm font-bold text-slate-800 mb-4">Yêu cầu chọn nhân viên</h3>
            <label className="flex items-center gap-3 cursor-pointer group">
              ...
              <span className="text-sm text-slate-700">Bắt buộc 'Chọn nhân viên' cho mỗi lịch hẹn</span>
          ...
          {/* No show */}
          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
            <h3 className="text-sm font-bold text-slate-800">Lịch hẹn không đến (No show)</h3>
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <span className="text-sm text-slate-700 leading-relaxed">Tự động đánh dấu lịch hẹn là 'Không đến' nếu chưa check-in sau một khoảng thời gian so với giờ bắt đầu</span>
            ...
            <div className={`pl-12 transition-opacity ${settings.autoNoShow ? 'opacity-100' : 'opacity-40 pointer-events-none'}`}>
              <div className="text-sm text-slate-500 mb-2">Thời gian chờ</div>
              ...
              <label className="flex items-center gap-2 mt-4 cursor-pointer">
                ...
                <span className="text-sm text-slate-600">Hiển thị thông báo xác nhận đánh dấu "Không đến"</span>
          ...
          {/* Cancellation prompt */}
          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
            <h3 className="text-sm font-bold text-slate-800">Thông báo hủy lịch hẹn không đến</h3>
            
            <div>
              <div className="text-sm text-slate-500 mb-2">Thời gian giữ lịch hẹn không đến trên lịch</div>
              <div className="relative">
                <select 
            ...
            <label className="flex items-center gap-2 mt-4 cursor-pointer">
              ...
              <span className="text-sm text-slate-600">Hiển thị thông báo hủy lịch hẹn không đến</span>
