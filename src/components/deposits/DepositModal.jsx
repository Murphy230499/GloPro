      ...
      {createPortal(
          ...
          <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl flex flex-col font-body animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
              ...
              <h2 className="text-lg font-bold text-slate-800">
                {editing ? 'Cập nhật Đặt cọc' : 'Tạo Đặt cọc Mới'}
              </h2>
              <p className="text-xs text-slate-500 font-medium">Mã: {form.deposit_number}</p>
            </div>
          </div>
        ...
        <div className="p-6 overflow-y-auto max-h-[70vh] space-y-4">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1.5 uppercase tracking-wider">Khách hàng</label>
              <CustomerPicker
                customers={customers}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-bold text-slate-700 mb-1.5 uppercase tracking-wider">Số tiền yêu cầu</label>
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 mb-1.5 uppercase tracking-wider">Đã thanh toán</label>
                <div className="relative">
                  <input 
                    type="text" 
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1.5 uppercase tracking-wider">Phương thức</label>
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1.5 uppercase tracking-wider">Ghi chú</label>
              <textarea 
                rows="3"
                value={form.notes || ''}
                onChange={e => setForm({...form, notes: e.target.value})}
                placeholder="Ghi chú về khoản đặt cọc..."
        ...
        <div className="p-4 border-t border-slate-100 bg-slate-50/50 rounded-b-2xl flex justify-end gap-3">
          ...
          >
            ...
            <span>{saving ? 'Đang lưu...' : 'Lưu đặt cọc'}</span>
          </button>
        </div>
