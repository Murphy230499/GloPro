        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            ...
            <select
              ...
              className="hidden sm:block w-full sm:w-auto flex-1 px-3 pr-8 py-2 rounded-xl border border-slate-200 text-sm text-slate-600 focus:outline-none focus:border-emerald-400 bg-white"
            >
        ...
        {filtered.length === 0 ? (
          ...
          <>
            ...
            <div className="md:hidden flex flex-col gap-3">
                  ...
                  <div key={v.id} className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow space-y-3">
                    <div className="flex justify-between items-start gap-2">
                      ...
                      <div className="text-right">
                        <div className="font-bold text-emerald-600 text-sm">{formatVND(v.amount)}</div>
                        <span
              ...
              <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 flex justify-between items-center mt-1 shadow-sm">
                <span className="text-xs font-bold text-emerald-700 uppercase tracking-wider">{t('cashflow.total_summary_prefix', 'Tổng cộng')} ({filtered.length})</span>
