        ...
        <div className="flex justify-between items-center p-5 border-b border-slate-100 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-slate-500 font-normal mt-0.5">Loại: <span className="text-pink-600 font-normal bg-pink-50 px-1.5 py-0.5 rounded">CTKM Tặng khách</span></div>
            </div>
          </div>
          <div className="flex items-center gap-3">
            {statusBadge}
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            <div className="bg-pink-50 rounded-2xl p-3.5 border border-pink-100 flex flex-col items-start gap-1">
              ...
              <div className="text-[11px] font-normal text-pink-600">Đã tặng cho khách</div>
              <div className="text-base font-semibold text-pink-700">{giftedList.length} <span className="text-xs font-normal">lượt</span></div>
              <div className="text-[10px] text-pink-600/80 mt-0.5 truncate font-normal">Dùng: {giftedUsedCount} • Chưa dùng: {giftedUnusedCount}</div>
            </div>
            ...
            <div className="bg-emerald-50 rounded-2xl p-3.5 border border-emerald-100 flex flex-col items-start gap-1">
              ...
              <div className="text-[11px] font-normal text-emerald-600">Sử dụng POS / Tổng</div>
              ...
              <div className="text-[10px] text-emerald-600/80 mt-0.5 truncate font-normal">Chưa dùng: {unusedQuantity !== null ? unusedQuantity : '—'}</div>
            </div>
            ...
            <div className="bg-blue-50 rounded-2xl p-3.5 border border-blue-100 flex flex-col items-start gap-1">
              ...
              <div className="text-[11px] font-normal text-blue-600">Doanh thu đem về</div>
              <div className="text-base font-semibold text-blue-700">{formatVND(totalRevenue)}</div>
              <div className="text-[10px] text-blue-600/80 mt-0.5 truncate font-normal">Chi phí: {formatVND(totalCost)}</div>
            </div>
            ...
            <div className="bg-purple-50 rounded-2xl p-3.5 border border-purple-100 flex flex-col items-start gap-1">
              ...
              <div className="text-[11px] font-normal text-purple-600">Khách hàng mới</div>
              <div className="text-base font-semibold text-purple-700">{newCustomerCount}</div>
              <div className="text-[10px] text-purple-600/80 mt-0.5 truncate font-normal">Khách dùng lần đầu</div>
            </div>
            ...
            <div className="bg-amber-50 rounded-2xl p-3.5 border border-amber-100 flex flex-col items-start gap-1">
              ...
              <div className="text-[11px] font-normal text-amber-600">Khách hàng cũ</div>
              <div className="text-base font-semibold text-amber-700">{returningCustomerCount}</div>
              <div className="text-[10px] text-amber-600/80 mt-0.5 truncate font-normal">Khách quay lại</div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 space-y-3">
              <h3 className="font-bold text-sm text-slate-800 flex items-center gap-1.5"><Tag className="w-4 h-4 text-slate-400" /> Thông tin khuyến mãi</h3>
            ...
            <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-y-3 text-sm">
                ...
                <div className="font-normal text-slate-700">{promo.startDate || '—'} đến {promo.expiryDate || '—'}</div>
                ...
                {promo.isAdvancedTime && (
                  <>
                    ...
                    <div className="font-normal text-slate-700">
                      {promo.timeType === 'daily' ? 'Hàng ngày' : promo.timeType === 'weekly' ? 'Hàng tuần' : 'Hàng tháng'}
                    </div>
                  </>
                )}
              </div>
