...
export default function AppointmentHeader({
  ...
  const formatDateDisplay = (dateStr) => {
    if (!dateStr || dateStr === todayISO) return 'Hôm nay';
  ...
  return (
    <div className="relative z-40 bg-white p-3 rounded-2xl border border-slate-200/80 shadow-2xs font-body mb-4 overflow-visible">
            ...
            {isStaffOpen && (
              <div className="absolute left-0 top-full mt-2 w-72 bg-white rounded-xl border border-slate-200 shadow-2xl z-[60] flex flex-col max-h-80 overflow-hidden animate-in fade-in zoom-in-95 duration-150 font-body">
                ...
                <div className="bg-[#f8fafc] px-4 py-3 border-b border-slate-100/80">
                  <input
                    type="text"
                    placeholder={targetEntity === 'staff' ? "tìm kiếm nhân viên..." : "tìm kiếm vị trí..."}
                    value={searchStaff}
