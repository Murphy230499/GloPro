    ...
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center" onClick={onClose}>
      ...
      <div className="relative bg-white w-full md:max-w-md rounded-3xl p-6 shadow-2xl relative text-left flex flex-col max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="space-y-3">
          ...
          <div>
            <label className="block font-medium text-slate-500 mb-1 text-[11px]">Nhóm gói dịch vụ</label>
            <div className="relative">
              ...
              >
                <option value="">— Chọn nhóm gói dịch vụ —</option>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="block font-medium text-slate-500 mb-1 text-[11px]">Giá gói (VNĐ)</label>
            ...
            <div>
              <label className="block font-medium text-slate-500 mb-1 text-[11px]">Số lần sử dụng</label>
          ...
          <div>
            <label className="block font-medium text-slate-500 mb-1 text-[11px]">Dịch vụ trong gói</label>
        ...
        <div className="flex gap-2 pt-4 border-t border-slate-150/50 mt-4 shrink-0">
          ...
          <button onClick={() => {
            if (!f.name) return toast.error('Nhập tên gói');
            const payload = { ...f };
