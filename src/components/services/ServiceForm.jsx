    ...
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center" onClick={onClose}>
      ...
      <div className="relative bg-white w-full md:max-w-md rounded-3xl p-6 shadow-2xl relative text-left flex flex-col max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="space-y-3">
          ...
          <div>
            <label className="block font-medium text-slate-500 mb-1 text-[11px]">Nhóm dịch vụ</label>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="block font-medium text-slate-500 mb-1 text-[11px]">Giá từ (VNĐ)</label>
            ...
            <div>
              <label className="block font-medium text-slate-500 mb-1 text-[11px]">Giá cố định (VNĐ)</label>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="block font-medium text-slate-500 mb-1 text-[11px]">Chi phí dịch vụ (VNĐ)</label>
            ...
            <div>
              <label className="block font-medium text-slate-500 mb-1 text-[11px]">Thời gian (phút)</label>
          ...
          <div>
            <label className="block font-medium text-slate-500 mb-1 text-[11px]">Sản phẩm đi kèm (tự trừ kho khi bán)</label>
              ...
              <div className="mt-2 space-y-1">
                {f.accompanied_products.map((ap) => (
                  <div key={ap.product_id} className="flex items-center gap-2 px-2.5 py-1.5 rounded-lg bg-slate-50 text-xs text-slate-600 font-normal">
                    ...
                    <span className="font-normal text-slate-500 text-[11px]">SL: {ap.quantity}</span>
