    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm">
          <h3 className="font-bold mb-1">Doanh thu 7 ngày qua</h3>
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm">
          <h3 className="font-bold mb-3 flex items-center gap-2"><Clock className="w-4 h-4 text-blue-500" /> Lịch hẹn sắp tới</h3>
          {upcoming.length === 0 ? (
