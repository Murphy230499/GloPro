          ...
          return (
            <div key={s.id} className={`rounded-2xl p-4 border border-slate-100 shadow-sm bg-blue-50 ${!s.is_active ? 'opacity-50' : ''}`}>
                ...
                <div className="flex gap-1.5 mt-3">
                  <button onClick={() => setEditing({ ...s, type: 'service' })} className="flex-1 text-xs py-2 rounded-full bg-slate-100 font-medium flex items-center justify-center gap-1 mx-20"><Edit3 className="w-3.5 h-3.5" />Sửa</button>
