  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
          ...
          return (
            <div key={s.id} className={`rounded-2xl p-4 border border-slate-100 shadow-sm bg-[hsl(var(--popover))] ${!s.is_active ? 'opacity-50' : ''}`}>
                ...
                <div className="flex gap-1.5 mt-3">
                  <button onClick={() => setEditing({ ...s, type: 'service' })} className="flex-1 text-xs rounded-full bg-slate-100 font-medium flex items-center justify-center gap-1"><Edit3 className="w-3.5 h-3.5" />Sửa</button>
